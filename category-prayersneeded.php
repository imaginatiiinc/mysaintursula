...
$posts = GFAPI::get_entries( 3, $search_criteria);
			...
			<div class="row">
                <div class="col-lg-12">
					...
					<div class="col-lg-3 pull-right">
							<a href="#" id="gotoform" style="color:#000080;font-size:21px">Post a New Prayer Request</a>
						</div>
					<hr/>
<?php
...
<?php
	...
	echo '<p>No Prayer Requests to display.</p>';
	}
?>
                </div>
            </div>
			...
			<div class="row">
                <div class="col-lg-12">
				<h4 id="startform">Post a New Prayer Request</h4>
<?php
...
gravity_form( 3, false, false, false, $field_values, false, $tabindex, $echo = true );
