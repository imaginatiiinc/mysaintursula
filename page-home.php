                ...
                <div class="col-lg-12">
					<div style="text-align: center; margin-bottom: 60px; font-size: 20px; color: rgb(254, 205, 51); font-weight: 700;">
						<span style="white-space: nowrap;">
							<a href="<?php echo site_url(); ?>" style="color: #ffc72c;">All</a>
						</span>
						<span style="white-space: nowrap;">
							&nbsp;&nbsp;&nbsp;
...
<!---						<span style="white-space: nowrap;">
						...
						<span style="white-space: nowrap;">
							&nbsp;&nbsp;&nbsp;
							<a href="<?php echo site_url( '/category/studentlife/'); ?>" style="color: <?php echo get_color('Student Life');?>;">Student Life</a>
						</span>
						<span style="white-space: nowrap;">
							&nbsp;&nbsp;&nbsp;
							<a href="<?php echo site_url( '/category/events/'); ?>" style="color: <?php echo get_color('Events');?>;">Events</a>
						</span>
						<span style="white-space: nowrap;">
							&nbsp;&nbsp;&nbsp;
							<a href="<?php echo site_url( '/category/birthscareersadoptions/'); ?>" style="color: <?php echo get_color('Alumnae Updates');?>;">Alumnae Updates</a>
						</span>
						<span style="white-space: nowrap;">
							&nbsp;&nbsp;&nbsp;
							<a href="<?php echo site_url( '/category/prayersneeded/'); ?>" style="color: <?php echo get_color('Prayers Needed');?>;">Prayers Needed</a>
						</span>
						<span style="white-space: nowrap;">
							&nbsp;&nbsp;&nbsp;
							<a href="<?php echo site_url( '/category/obituaries/'); ?>" style="color: <?php echo get_color('Obituaries');?>;">Obituaries</a>
						</span>
					</div>
				</div>
			</div>
			...
			<div class="row">
                <div class="col-lg-12">
                    <h2>Welcome, <?php echo $user_fields['first_name']; ?>!</h2>
					<p><a href="<?php echo site_url('/profile/'); ?>">Click here to update your profile</a></p>
					<hr/>
<?php
if(!empty($posts)) {
?>
...
?>  
                                        <h2 class="post-title" style="margin-bottom: 0px; font-size: 30px; color: rgb(1, 44, 95);"><a href="<?php echo site_url('/st-ursula-news/');?>" style="color: rgb(1, 44, 95);">More News &raquo;</a></h2>
<hr />
                </div>
            </div>
            <div class="row">
